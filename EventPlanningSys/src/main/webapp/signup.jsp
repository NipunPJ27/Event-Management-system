      ...
      <div class="container_signup">
        <div class="left-side">
          <div class="signup_sections">
            <h2>For Event planners, Service providers, Sponsors</h2>
            <br />
            <p>
              "Join our platform to streamline your business outreach and
              connect with clients effortlessly."
            </p>
            <br />
            <a href="businessSign.jsp"
              ><button class="signup_button">Sign up</button></a
            >
          </div>
        </div>
        <div class="right-side">
          ...
          <h2>For Clients</h2>
            <br />
            <p>
              "Unlock the power to make your events truly exceptional by signing
              up on our platform."
            </p>
            <br />
            <a href="clientsign.jsp"
              ><button class="signup_button">Sign up</button></a
            >
          </div>
        </div>
