...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <div class="event_requenst">
        <h2>New Event Request</h2>
        <br />
        <form action="ReqstInsert" method="post">
          <label for="eventPurpose">Event Purpose:</label>
          <select id="eventPurpose" name="eventPurpose">
          ...
          <div>
            <label>
              <input type="radio" id="budget-low" name="budget" value="low" />
              Low
            </label>
          </div>
          <div>
          ...
          <input type="number" id="attendance" name="attendance" min="1" />
