...
<html lang="en">
  ...
  <body>
    ...
    <form action="DeleteDataServlet" method="post">
      ...
      Event purpose :<input type="text" name="purpose" value="<%= purpose%>" readonly><br>
      Email :<input type="email" name="email" value="<%= email%>" readonly><br>
      Event name :<input type="text" name="ename" value="<%= ename%>" readonly><br>
      Budget :<input type="text" name="budjet" value="<%= budjet%>" readonly><br>
      Expected Attendance :<input type="text" name="attendance" value="<%= attendance%>" readonly><br>
