...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/src/styleSignup.css" />
    <link rel="stylesheetjs" href="/src/login.js" />
    ...
    <main>
      <div class="signup_form_b">
        ...
        <form action="businessInsert" method="post">
          <label for="name">Name/ Name of the Company</label>
          <input type="text" id="name" name="name" required />
          <br />

          <label for="type">Type of business</label>
          <select id="type" name="Businesstype" required>
            <option name="Service Provider" value="Service_Provider">Service Provider</option>
            <option name="Sponsor" value="Sponsor">Sponsor</option>
          </select>
          <br />

          <label for="type">Type of service</label>
          <select id="type" name="Servicetype" required>
            <option name="Catering" value="Catering">Catering</option>
            <option name="Decorations" value="Decorations">Decorations</option>
          ...
          <input type="tel" id="contact" name="contact" required pattern="[0-9]+" required />
          <br />

          <label for="business-reg">Business Registration No:</label>
          <input type="text" id="business-reg" name="business-reg" required />
          <br />
